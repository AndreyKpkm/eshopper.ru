                ...
                <div class="product-details"><!--product-details-->
                    ...
                    <div class="col-sm-7">
                        <div class="product-information"><!--/product-information-->
                            ...
                            <p><b>Наличие:</b> <?= ($product['availability']) ? "В наличии" : "Нет в наличии" ?></p>
                            <?php if ($product['is_new']) echo "<p><b>Состояние:</b> Новый</p>"; ?>
                            <?php if ($product['brand']) echo "<p><b>Бренд:</b> {$product['brand']} </p>"; ?>
                ...
                <div class="category-tab shop-details-tab"><!--category-tab-->
                    <div class="col-sm-12">
                        <ul class="nav nav-tabs">
                            ...
                            <li><a href="#tag" data-toggle="tab">Тэг</a></li>
                            <li><a href="#reviews" data-toggle="tab">Отзывы (5)</a></li>
                        </ul>
                    </div>
